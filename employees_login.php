                        ...
                        <form action="<?= $BASE_URL ?>employees_auth.php" method="POST">
                            ...
                            <div class="login-form-card d-flex justify-content-center">
                                <div class="d-block text-center" style="width: 40%;">
                                    <input type="text" name="employees_email" class="form-control mt-3" placeholder="Email:">
                                    <input type="password" name="employees_password" class="form-control mt-3" placeholder="Senha:">
